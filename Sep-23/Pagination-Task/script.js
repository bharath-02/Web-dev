...
l1.setAttribute('class','page-item');
var a1=document.createElement('a');
a1.setAttribute('class','page-link');
a1.setAttribute('href','#');
a1.setAttribute('onclick','addData(0,9)');
a1.innerHTML='1';
...
a2.setAttribute('onclick','addData(10,19)');
a2.innerHTML='2';
...
function addData(start,end) {
    ...
    //  Appending the heading stuffs
    thead.append(row1);
    row1.append(head1,head2,head3);

    //  Looping to create the rows for displaying the data
    for(var itr=start;itr<=end;itr++) {
        //  Creating the rows for the table
        var row=document.createElement('tr');
        var data1=document.createElement('td');
        data1.innerHTML=data[itr].id;
        var data2=document.createElement('td');
        data2.innerHTML=data[itr].name;
        var data3=document.createElement('td');
        data3.innerHTML=data[itr].email;
       
        //  Appending the row stuffs
        tbody.append(row);
        row.append(data1,data2,data3);
    }
}

//  Appending the pagination items to the body
document.body.append(nav);
nav.append(ul);
ul.append(l1,l2,l3,l4,l5,l6,l7,l8,l9,l10);
l1.append(a1);
l2.append(a2);  
l3.append(a3);  
l4.append(a4);  
